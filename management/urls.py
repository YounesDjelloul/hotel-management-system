...
urlpatterns = [
    ...
    path('hotels/get/', GetHotelsView.as_view(), name="get_hotels"),
    path('hotels/reservation/validate/', ValidateHotelReservation.as_view(), name="validate_hotel_reservation"),
]